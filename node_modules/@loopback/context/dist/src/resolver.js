...
function resolve(ctx, injection, session) {
    ...
    let resolved = resolution_session_1.ResolutionSession.runWithInjection(s => {
...
nonInjectedArgs) {
    ...
    const argsOrPromise = resolveInjectedArguments(target, method, ctx, undefined, nonInjectedArgs);
    const targetWithMethods = target;
    assert(typeof targetWithMethods[method] === 'function', `Method ${method} not found`);
