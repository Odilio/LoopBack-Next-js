 ...
 */
export declare function bindingTemplateFor(cls: Constructor<unknown>): BindingTemplate;
/**
 ...
 */
export declare function createBindingFromClass(cls: Constructor<unknown>, options?: BindingFromClassOptions): Binding;
