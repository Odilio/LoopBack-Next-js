...
class Binding {
    ...
    getValue(ctx, session) {
        ...
        if (this._getValue) {
            let result = resolution_session_1.ResolutionSession.runWithBinding(s => this._getValue(ctx, s), this, session);
    ...
    toClass(ctor) {
        ...
        this._getValue = (ctx, session) => resolver_1.instantiateClass(ctor, ctx, session);
