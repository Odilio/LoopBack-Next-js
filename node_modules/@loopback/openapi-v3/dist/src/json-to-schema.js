 ...
 */
function jsonToSchemaObject(json) {
    const result = {};
    const propsToIgnore = [
        'anyOf',
        'oneOf',
    ...
    for (const property in json) {
        ...
        switch (property) {
            ...
            case 'definitions': {
                result.definitions = _.mapValues(json.definitions, def => jsonToSchemaObject(jsonOrBooleanToJSON(def)));
                break;
            }
            case 'properties': {
                result.properties = _.mapValues(json.properties, item => jsonToSchemaObject(jsonOrBooleanToJSON(item)));
                break;
            }
            case 'additionalProperties': {
                if (typeof json.additionalProperties !== 'boolean') {
                    result.additionalProperties = jsonToSchemaObject(json.additionalProperties);
                }
                break;
            }
            case 'items': {
