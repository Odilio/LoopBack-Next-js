...
function param(paramSpec) {
    return function (target, member, index) {
        ...
        const methodSig = context_1.MetadataInspector.getDesignTypeForMethod(target, member);
        ...
        if (paramType) {
            ...
            !paramSpec.schema ||
                ...
                (openapi_v3_types_1.isSchemaObject(paramSpec.schema) && !paramSpec.schema.type)) {
        ...
        if (paramSpec.schema &&
            openapi_v3_types_1.isSchemaObject(paramSpec.schema) &&
        ...
        context_1.ParameterDecoratorFactory.createDecorator(keys_1.OAI3Keys.PARAMETERS_KEY, paramSpec)(target, member, index);
    };
}
exports.param = param;
/**
...
function createParamShortcut(source, options) {
    return (name) => {
        return param({ name, in: source, schema: Object.assign({}, options) });
    };
}
