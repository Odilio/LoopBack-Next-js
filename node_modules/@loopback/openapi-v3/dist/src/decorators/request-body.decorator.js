...
function requestBody(requestBodySpec) {
    return function (target, member, index) {
        ...
        context_1.ParameterDecoratorFactory.createDecorator(keys_1.OAI3Keys.REQUEST_BODY_KEY, requestBodySpec)(target, member, index);
    };
}
...
(function (requestBody) {
    ...
    requestBody.array = function (itemSpec, properties) {
        return requestBody(Object.assign({}, properties, { content: {
                'application/json': {
